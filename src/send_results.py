...
if __name__ == "__main__":
    ...
    video_game_metrics = {
        "accuracy": video_game_model_accuracy,
        "runtime": video_game_model_runtime,
    }
    ...
    life_expectancy_metrics = {
        "accuracy": life_expectancy_model_accuracy,
        "runtime": life_expectancy_model_runtime,
    }

    # old_send_results(username, video_game_results, life_expectancy_results)
    user_results = UserResults(
        username=username, datasets={"Video Games": video_game_metrics}
    )
